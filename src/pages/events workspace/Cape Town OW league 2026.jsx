...
export const EVENT_ID = "13ec17e8-da24-42fb-8f3c-571c63c97d0c";
export const EVENT_SLUG = "cape-town-ow-league-2026";
export const EVENT_NAME = "Cape Town Open/Women's League 2026";
...
export default function CapeTownOwLeague26Page() {
        ...
        {loading ? (
          ...
          <>
            <Card className="space-y-3 p-6 sm:p-8">
              <SectionHeader
                eyebrow="Event"
                title={eventData.name || EVENT_NAME}
